            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-2xl border border-slate-200/90 py-3 z-50 animate-in fade-in zoom-in-95">
                <div className="px-4 pb-2 border-b border-slate-100 flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-600">3 New</span>
                </div>
                <div className="divide-y divide-slate-100 text-xs max-h-60 overflow-y-auto">
                  <div className="p-3 hover:bg-slate-50 transition cursor-pointer">
                    <p className="font-bold text-slate-800">Manpreet Singh invited you</p>
                    <p className="text-slate-500 mt-0.5">To join "Pulse Dev Core" workspace</p>
                    <span className="text-[10px] text-slate-400 mt-1 block">5m ago</span>
                  </div>
                  <div className="p-3 hover:bg-slate-50 transition cursor-pointer">
                    <p className="font-bold text-slate-800">Task Assigned</p>
                    <p className="text-slate-500 mt-0.5">RBAC authorization middleware</p>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden lg:block text-left">
              ...
              <p className="text-[10px] font-semibold text-indigo-600 mt-0.5">Admin</p>
            </div>
            <svg
