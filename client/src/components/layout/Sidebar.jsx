      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-5">
          ...
          >
            ...
            <a
              href="#"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 cursor-pointer mt-0.5"
        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold leading-none truncate" style={{ color: "#e2e8f0" }}>
                John Doe
              </p>
