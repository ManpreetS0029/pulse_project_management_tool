...
export default function WorkspaceInvite() {
  ...
  return (
    <div
      ...
      style={{
        background:
          'radial-gradient(ellipse at top left, #1e1b4b 0%, #0f172a 50%, #020617 100%)',
      }}
    >
      {/* Toast Notification */}
      {toast && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-5 py-3 rounded-2xl shadow-2xl text-white text-sm font-semibold bg-slate-900/90 border border-slate-700/60 backdrop-blur-md animate-fade-in">
          {toast}
        </div>
      )}
      ...
      <div className="w-full max-w-lg">
        ...
        {/* Card Box */}
        <div className="bg-slate-900/70 border border-slate-800 backdrop-blur-xl rounded-3xl p-6 sm:p-10 shadow-2xl shadow-black/40">
          {loading ? (
            ...
            <div className="text-center py-6 space-y-5 animate-fade-in">
              ...
              <div className="pt-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-6 py-3 rounded-xl text-sm font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]"
                  style={{
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-slate-400 leading-relaxed max-w-sm mx-auto">
                  {workspace?.description ||
                    'You have been invited to join and collaborate on projects in this workspace.'}
                </p>
              </div>
